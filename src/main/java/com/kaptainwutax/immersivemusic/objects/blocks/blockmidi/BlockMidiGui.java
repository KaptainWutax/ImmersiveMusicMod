...
public class BlockMidiGui extends GuiScreen {
    ...
    public void setText() {
        ...
        if (fileNameText == "") {
            fontRenderer.drawString("Storing no MIDI file." + fileNameText, centerX - 85, centerY + 115, 0x747c83);
        } else {
            fontRenderer.drawString("Storing MIDI file " + fileNameText, centerX - 85, centerY + 115, 0x747c83);
        }
